...
var Room = /** @class */ (function () {
    ...
    Room.prototype.generateRoomID = function () {
        return "xxxxxxxx".replace(/[xy]/g, function (_c) {
            var r = Math.random() * 16 | 0, v = _c == "x" ? r : (r & 0x3 | 0x8);
            return v.toString(16);
        });
    };
    Room.prototype.fetchQRCode = function () {
        return __awaiter(this, void 0, void 0, function () {
            var requestURL, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requestURL = "https://chart.googleapis.com/chart?cht=qr&chs=" + this.qrSize + "x" + this.qrSize + "&chl=" + this.url + "&chld=Q|1";
